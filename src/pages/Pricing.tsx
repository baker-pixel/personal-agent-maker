...
const departments = [
  ...
  },
  {
    ...
    price: null,
    period: null,
    desc: "Your full-service digital marketing agency powered by AI — client portal, campaigns, social media, analytics, and reporting.",
    features: [
    ...
    detail: {
      headline: "A full digital marketing agency in your pocket",
      paragraphs: [
        "Orange Door is Normy's dedicated marketing arm — a complete AI-powered digital marketing agency built for SMBs. It provides a branded client portal where you can track projects, review deliverables, and monitor campaign performance in real time.",
        "Need a social media strategy? Orange Door analyzes your industry, competitors, and audience — then builds a content calendar, drafts posts, and schedules them across platforms. It monitors engagement and optimizes what's working automatically.",
        "The built-in marketing gap analysis identifies where your business is underperforming compared to competitors and recommends specific, actionable improvements — from SEO and paid ads to email campaigns and brand positioning.",
      ],
      extras: [
        "Branded client portal with 20+ management tabs",
