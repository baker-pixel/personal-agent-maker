  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <div className="bg-card rounded-2xl border border-border/40 p-7 space-y-5 shadow-sm">
          {!isForgot && (
            <>
              <button
                type="button"
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-border/60 bg-muted/30 text-foreground font-medium text-sm hover:bg-muted/60 transition-all duration-200 disabled:opacity-60"
              >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-11 py-3 rounded-xl bg-muted/50 border border-border/60 text-foreground placeholder:text-muted-foreground/40 focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent/30 transition-all text-sm"
                    placeholder="••••••••"
                    required
                    minLength={6}
                  />
